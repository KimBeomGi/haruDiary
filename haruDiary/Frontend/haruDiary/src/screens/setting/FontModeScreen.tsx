...
import { whatFSValueSet, whatFSValueGet, isLightGet, isLightSet, whatFontGet, whatFontSet } from '../../asyncStorage/asyncStorage';
...
function FontModeScreen(): React.JSX.Element {
  ...
  // 폰트 사이즈 저장하기
  const handleWhatFSValueSet = (value: number) =>{
    dispatch(setFontSizeValue(value))
    whatFSValueSet(value)
  }
